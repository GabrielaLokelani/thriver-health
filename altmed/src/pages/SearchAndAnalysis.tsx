          ...
          >
            <div className="relative">
              <Search size={20} className="absolute left-4 top-1/2 transform -translate-y-1/2 text-warm-400" />
                  ...
                  className="w-full pl-12 pr-6 py-4 border border-sage-200 rounded-xl focus:ring-2 focus:ring-lavender-500 focus:border-transparent text-lg transition-all duration-300 bg-white/80 backdrop-blur-sm text-warm-800"
                />
            </div>
          </motion.div>
        </section>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-6 rounded-xl border transition-all duration-300 ${
                      selectedResult?.id === result.id
                        ? 'border-lavender-500 bg-electric-500/20 shadow-lg'
                        : 'border-sage-200 hover:border-sage-300 hover:bg-warm-600/30 hover:shadow-md'
                    }`}
                  >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center mb-3">
                          <span className={`inline-block w-3 h-3 rounded-full mr-3 ${
                            result.type === 'condition' ? 'bg-lime-500/200' : 'bg-electric-500/200'
                          }`} />
                          <span className="text-sm text-warm-400 uppercase font-medium">
                            {result.type}
                          </span>
                        </div>
                        ...
                        <p className="text-base text-warm-300 line-clamp-2 leading-relaxed">
                          {result.description}
                        </p>
                      </div>
                ...
                {searchResults.length === 0 && searchTerm && (
                  <div className="text-center py-12 text-warm-400">
                    <Search size={48} className="mx-auto mb-6 text-warm-400" />
          ...
          <div className="lg:col-span-2">
            {selectedResult ? (
              ...
              >
                {/* Tabs */}
                <div className="flex space-x-2 bg-warm-700/50 p-2 rounded-xl mb-8">
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 py-3 px-6 rounded-lg text-base font-medium transition-all duration-300 flex items-center justify-center ${
                        activeTab === tab.id
                          ...
                          : 'text-warm-800 hover:text-white hover:bg-white/50'
                      }`}
                    >
                    ...
                    <div className="mb-8">
                      ...
                      {selectedResult.type === 'treatment' && (
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                          <div className="bg-warm-600/30 p-6 rounded-xl">
                            <h3 className="text-lg font-semibold text-white mb-3">Dosage Information</h3>
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="text-center p-6 bg-electric-500/20 rounded-xl">
                          ...
                          <div className="text-base text-warm-300">Research Studies</div>
                        </div>
                        <div className="text-center p-6 bg-orange-500/20 rounded-xl">
                          <div className="text-3xl font-bold text-orange-400 mb-2">
                            {selectedResult.data.testimonialCount}
                          </div>
                          <div className="text-base text-warm-300">User Testimonials</div>
                        </div>
                        <div className="text-center p-6 bg-lime-500/20 rounded-xl">
                          ...
                          <div className="text-base text-warm-300">Effectiveness Score</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6">
                      {getTestimonialsByTreatment(selectedResult.id).map((testimonial) => (
                        <div key={testimonial.id} className="border border-sage-200 rounded-xl p-6 hover-lift">
                          ...
                          <p className="text-warm-300 text-base mb-4 line-clamp-3 leading-relaxed">
                            {testimonial.content}
                          </p>
                ...
                {activeTab === 'research' && (
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-warm-600/30 p-4 rounded-lg">
                        ...
                        <button className="text-electric-400 hover:text-electric-400 text-sm font-medium flex items-center">
                          View Research Papers
                          <ExternalLink size={14} className="ml-1" />
                        </button>
                      </div>
                      
                      <div className="bg-electric-500/20 p-4 rounded-lg">
                        <h4 className="font-semibold text-white mb-2">
                          Legal Status
                        </h4>
                        <div className="flex items-center">
                          {selectedResult.type === 'treatment' && (
                            <>
                              ...
                              <span className="text-sm text-warm-300 capitalize">
                  ...
                  <div>
                    ...
                    {isLoading ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-warm-300">Analyzing data and generating insights...</p>
                      </div>
                    ) : aiAnalysis ? (
                      <div className="space-y-6">
                        <div className="bg-gradient-to-r from-lavender-50 to-rose-50 p-4 rounded-lg">
                          ...
                          <p className="text-warm-300">{aiAnalysis.summary}</p>
                        </div>

                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-warm-600/30 p-4 rounded-lg">
                            <h4 className="font-semibold text-white mb-2">Effectiveness</h4>
                          ...
                          <div className="bg-warm-600/30 p-4 rounded-lg">
                            <h4 className="font-semibold text-white mb-2">Community Consensus</h4>
                            <p className="text-sm text-warm-300">{aiAnalysis.consensus}</p>
                          </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-green-50 p-4 rounded-lg">
                            ...
                            <ul className="space-y-1">
                              {aiAnalysis.benefits.map((benefit, index) => (
                                <li key={index} className="text-sm text-warm-300 flex items-center">
                          ...
                          <div className="bg-red-50 p-4 rounded-lg">
                            <h4 className="font-semibold text-white mb-2">Risks</h4>
                            <ul className="space-y-1">
                        ...
                        <div className="bg-purple-50 p-4 rounded-lg">
                          <h4 className="font-semibold text-white mb-2">Treatment Protocol</h4>
                          <div className="grid md:grid-cols-2 gap-4">
                            <div>
                              <h5 className="font-medium text-white mb-2">Dosage Guide</h5>
                            ...
                            <div>
                              <h5 className="font-medium text-white mb-2">Where to Buy</h5>
                              <div className="space-y-2">
                                <button className="w-full text-left p-2 bg-white rounded border border-purple-200 hover:border-purple-300 transition-colors text-sm">
                                  <div className="font-medium text-white">🏥 Pharmacy Grade</div>
                                  <div className="text-xs text-warm-300">Prescription required</div>
                                </button>
                                <button className="w-full text-left p-2 bg-white rounded border border-purple-200 hover:border-purple-300 transition-colors text-sm">
                                  <div className="font-medium text-white">🛒 Veterinary Grade</div>
                                  <div className="text-xs text-warm-300">Available online</div>
                                </button>
                              </div>
                            </div>
                          </div>
              ...
              >
                <Search size={48} className="text-warm-400 mx-auto mb-4" />
