    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Student Goals</h2>
            <p className="mt-1 text-sm text-gray-500">
              Monitor and support student goal progress
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="mt-1 text-2xl font-semibold text-gray-900">
                {currentStudent?.goals.reduce((acc, goal) => acc + goal.progress, 0) / (currentStudent?.goals.length || 1)}%
              </p>
            </div>
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="text-sm font-medium text-gray-500">Completed Goals</h4>
              <p className="mt-1 text-2xl font-semibold text-gray-900">
                {currentStudent?.goals.filter(goal => goal.status === 'completed').length || 0}
              </p>
            </div>
          </div>
        </div>
