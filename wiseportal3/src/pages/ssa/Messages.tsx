  ...
  const chats: Chat[] = [
    {
      ...
      unread: true,
      messages: [
        { id: '1', sender: 'John', content: 'Hello, I need help with my scholarship application', timestamp: '1 day ago', isFromMe: false },
        { id: '2', sender: 'Me', content: 'I\'ll be happy to help. What specific questions do you have?', timestamp: '1 day ago', isFromMe: true },
        { id: '3', sender: 'John', content: 'Thank you for your guidance!', timestamp: '1 day ago', isFromMe: false },
      ]
    },
        ...
        <div className="bg-[var(--wise-yellow-light)] p-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-600">
              My Network enables communication across the WISE Portal platform. As an SSA, 
              you can communicate with students and mentors. All communications are monitored 
